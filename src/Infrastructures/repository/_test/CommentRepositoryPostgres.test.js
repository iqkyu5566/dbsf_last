...
describe("CommentRepositoryPostgres", () => {
  ...
  describe("verifyCommentOwner function", () => {
    ...
    it("should return nothing when owner is the same as the payload", async () => {
      await UsersTableTestHelper.addUser({});
      await ThreadsTableTestHelper.addThread({});
      await CommentsTableTestHelper.addComment({});
  ...
  describe("deleteCommentById function", () => {
    it("should return NotFoundError when comment is not available", async () => {
      ...
      await expect(commentRepositoryPostgres.deleteCommentById("123")).rejects.toThrowError(NotFoundError);
    });
  ...
  describe("verifyAvailableCommentInThread function", () => {
    it("should return NotFoundError when thread is unavailable", async () => {
      ...
      await expect(commentRepositoryPostgres.verifyAvailableCommentInThread("comment-123", "thread-123")).rejects.toThrowError(NotFoundError);
    });
    ...
    it("should return nothing when thread and comment are available", async () => {
      await UsersTableTestHelper.addUser({});
      await ThreadsTableTestHelper.addThread({});
      await CommentsTableTestHelper.addComment({});
